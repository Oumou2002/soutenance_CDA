                            ...
                            <div className="workspace-panel">
                                <div className="workspace-panel-head">
                                    ...
                                    <p className="workspace-subtitle">
                                        Utilisez un mot de passe long, unique et difficile a deviner.
                                    </p>
                                </div>
                                ...
                                <div className="workspace-panel-body">
                                    <form className="workspace-grid" onSubmit={changePasswordSubmit}>
                                        <div className="workspace-grid-full">
                                            <label className="form-label" htmlFor="old-password-student">
                                                Mot de passe actuel
                                            </label>
                                            <input
                                                id="old-password-student"
                                                type="password"
                                        ...
                                        <div>
                                            <label className="form-label" htmlFor="new-password-student">
                                        ...
                                        <div>
                                            <label className="form-label" htmlFor="confirm-password-student">
